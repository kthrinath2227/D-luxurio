    ...
    return (
        <div className="sticky top-0 h-screen flex items-center justify-center">
            <motion.div
                ...
                className="relative w-[90%] max-w-4xl h-[60vh] rounded-2xl overflow-hidden shadow-2xl cursor-pointer"
...
const DesignSeries = () => {
    ...
    return (
    <section id="design-series" ref={containerRef} className="relative h-[500vh] bg-transparent">
